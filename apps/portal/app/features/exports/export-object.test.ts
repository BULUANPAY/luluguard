...
describe("export object helpers", () => {
  it("creates a valid randomized draft", () => {
    ...
    expect(draft.exporterCompany).toBe("哈利波特怪物商");
  });

  it("maps form values to the API-shaped JSON payload", () => {
    const draft = createRandomExportObject("哈利波特怪物商", new Date("2026-08-29"));
    ...
    expect(payload.exporter.companyName).toBe("哈利波特怪物商");
